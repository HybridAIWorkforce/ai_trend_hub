...
export async function PATCH(
  ...
  try {
    ...
    const { title, currentContentMarkdown, outlineJson, status, publishStatus, publishError, wizardStep, wizardDataJson, createVersion } = body;
    ...
    const updatedArticle = await prisma.article.update({
      ...
      data: {
        ...
        ...(wizardDataJson !== undefined && { wizardDataJson }),
      },
      include: {
